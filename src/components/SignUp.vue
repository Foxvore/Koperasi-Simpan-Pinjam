        ...
        <div class="formBx">
          ...
          <div>
            ...
            <span class="show-hide1"
              ><i class="fa-solid fa-eye" id="show1" v-on:click="showHide1"></i
            ></span>
          ...
          <p class="signup">
            ...
            <a href="#" v-on:click="toggleForm">Sign Up.</a>
          </p>
        </div>
      </div>
        ...
        <div class="formBx">
          ...
          <div>
            ...
            <input
              ...
              id="pass2"
            />
            <span class="show-hide2"
              ><i class="fa-solid fa-eye" id="show2" v-on:click="showHide2"></i
            ></span>
            <span v-if="v$.password.$error" id="error">
              {{ v$.password.$errors[0].$message }}
            </span>
            ...
            <input
              ...
              id="pass3"
            />
            <span class="show-hide3"
              ><i class="fa-solid fa-eye" id="show3" v-on:click="showHide3"></i
            ></span>
          ...
          <p class="signin">
            ...
            <a href="#" v-on:click="toggleForm">Login.</a>
          </p>
        </div>
